  ...
  CzAAqYTVOPWO2yYAAAAASUVORK5CYII="
        ...
        1272.8,407.8 		"
            ...
            >
              ...
              <stop
                offset={1}
                style={{ stopColor: "#202333", stopOpacity: 0 }}
              />
            </linearGradient>
            <polygon
              className="particlespoly"
      ...
      {ismessage ? (
        <>
          ...
          <span className="text-white text-4xl mt-3">Waiting... </span>{" "}
        </>
      ) : (
        <>
          {" "}
     
          <span className="text-white text-4xl mt-3">Your wallet is loading, Please Wait... </span>
        </>
      )}
    </div>
  );
